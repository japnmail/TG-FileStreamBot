...
<b>©️ Spidey | Mindflayer's Mirror</b>\n
<i>Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ (ᴏʀ) ʀᴇᴘᴏʀᴛ ʙᴜɢꜱ</i> <b>: <a href='https://t.me/arvinxoxo'>[ ᴄʟɪᴄᴋ ʜᴇʀᴇ ]</a></b>"""
...
class BUTTON(object):
    START_BUTTONS = InlineKeyboardMarkup(
        ...
        [InlineKeyboardButton("📢 info", url=f'https://t.me/{Var.UPDATES_CHANNEL}')]
        ]
    )
